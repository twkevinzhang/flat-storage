...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    FilesFilterDialog: typeof import('./dialogs/FilesFilterDialog.vue')['default']
    FilesOrderDialog: typeof import('./dialogs/FilesOrderDialog.vue')['default']
    FilesSortDialog: typeof import('./dialogs/FilesSortDialog.vue')['default']
